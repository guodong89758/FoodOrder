...
public class EmptyLayout {
    ...
    private void initDefaultValues() {
        ...
        emptyDrawable = R.drawable.ic_def_error;
        errorDrawable = R.drawable.ic_def_error;
        loadingStr = RT.getString(R.string.def_data_loading);
        emptyStr = RT.getString(R.string.def_empty_data_text);
        errorStr = RT.getString(R.string.def_net_error_text);
        emptyButtonTitle = RT.getString(R.string.def_empty_button_retry);
        errorButtonTitle = RT.getString(R.string.def_empty_button_retry);
        lineSpacingExtra = PhoneUtil.dipToPixel(5, RT.application);
    ...
    private void initView() {
        if (mLoadingView == null) {
            ...
            temp_view = mLoadingView.findViewById(R.id.temp_view);
        }
