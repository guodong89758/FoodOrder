...
//        btn_pack.setOnClickListener(this);
        ...
        GridLayout.LayoutParams params1 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_1)).getLayoutParams();
        params1.width = btn_width;
        params1.height = btn_height;
        GridLayout.LayoutParams params2 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_2)).getLayoutParams();
        params2.width = btn_width;
        params2.height = btn_height;
        GridLayout.LayoutParams params3 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_3)).getLayoutParams();
        params3.width = btn_width;
        params3.height = btn_height;
        GridLayout.LayoutParams params4 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_4)).getLayoutParams();
        params4.width = btn_width;
        params4.height = btn_height;
        GridLayout.LayoutParams params5 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_5)).getLayoutParams();
        params5.width = btn_width;
        params5.height = btn_height;
        GridLayout.LayoutParams params6 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_6)).getLayoutParams();
        params6.width = btn_width;
        params6.height = btn_height;
        GridLayout.LayoutParams params7 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_7)).getLayoutParams();
        params7.width = btn_width;
        params7.height = btn_height;
        GridLayout.LayoutParams params8 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_8)).getLayoutParams();
        params8.width = btn_width;
        params8.height = btn_height;
        GridLayout.LayoutParams params9 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_9)).getLayoutParams();
        params9.width = btn_width;
        params9.height = btn_height;
        GridLayout.LayoutParams params0 = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_0)).getLayoutParams();
        params0.width = btn_width * 3;
        params0.height = btn_height;
        GridLayout.LayoutParams params_back = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_back)).getLayoutParams();
        params_back.width = btn_width;
        params_back.height = btn_height;
        GridLayout.LayoutParams params_clear = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_clear)).getLayoutParams();
...
//        params_pack.width = btn_width * 2;
        GridLayout.LayoutParams params_send = (GridLayout.LayoutParams) ((Button)findViewById(R.id.btn_send)).getLayoutParams();
