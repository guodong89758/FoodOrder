...
public class GoodListPadActivity1 extends BaseActivity implements BaseRecyclerAdapter.OnItemClickListener {
...
//    private CheckBox cb_pack;
    ...
    protected int getLayoutId() {
        return R.layout.activity_good_list_pad1;
    }
...
//                }
                ...
                .subscribe(new Observer<Object>() {
                    ...
                    public void onCompleted() {
                        typeAdapter = new TypeAdapter(GoodListPadActivity1.this, goodTypeList);
                        typeAdapter.setOnItemClickListener(GoodListPadActivity1.this);
                        rvType.setAdapter(typeAdapter);

                        myAdapter = new GoodsPadAdapter1(GoodListPadActivity1.this, goodList);
        ...
        public void handleMessage(int what, int arg1, int arg2, Object dataobj) {
            switch (what) {
                ...
                case EventTag.POPUP_FORMULA_SHOW:
                    FormulaPop formulaPop = new FormulaPop(GoodListPadActivity1.this, (Good) dataobj, FormulaPop.TYPE_MENU);
                    formulaPop.showPopup();
                    break;
                case EventTag.POPUP_ATTRIBUTE_SHOW:
                    AttributePop attrPop = new AttributePop(GoodListPadActivity1.this, (Good) dataobj, arg2);
                    attrPop.showPopup();
                    break;
...
//                }
    ...
    public void onItemClick(View view, int position, long id) {
        GoodType type = goodTypeList.get(position);
        if (type != null) {
            onTypeClicked(type.getPosition());
        }
    }
...
//
    ...
    public void onTypeClicked(int typeId) {
        if (gv_good.getAdapter() != null) {
            DLOG.d("position = " + gv_good.getAdapter().getGridViewPositionFromHeaderId(typeId - 1));
//        gv_good.smoothScrollToPosition(getSelectedPosition(typeId));
        ...
        selectAdapter.setOnItemClickListener(new SelectAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position, Good good) {
                if (good.getFormulaList() != null && good.getFormulaList().size() > 0) {
                    FormulaPop formulaPop = new FormulaPop(GoodListPadActivity1.this, good, FormulaPop.TYPE_UPDATE);
                    formulaPop.showPopup();
                } else if (good.getAttributeList() != null && good.getAttributeList().size() > 0) {
                    AttributePop attrPop = new AttributePop(GoodListPadActivity1.this, good, AttributePop.TYPE_UPDATE);
                    attrPop.showPopup();
                }
